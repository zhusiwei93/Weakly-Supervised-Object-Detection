...
The official Weakly Supervised Deep Detection Networks (WSDDN) code (written in MATLAB) is available [here](https://github.com/hbilen/WSDDN).
If your goal is to reproduce the results in the WSDDN paper, please use the [official code](https://github.com/hbilen/WSDDN).

This repository contains a Python *reimplementation* of the MATLAB code.
This Python implementation is built on a fork of [py-faster-rcnn](https://github.com/rbgirshick/py-faster-rcnn).
